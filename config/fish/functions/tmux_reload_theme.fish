function tmux_reload_theme -a color_scheme
    ...
    tmux source ~/.config/tmux/theme.$color_scheme.tmux
...
function tmux_session_reload_theme -a tmux_session -a color_scheme
    ...
    tmux source -t $tmux_session ~/.config/tmux/theme.tmux
    tmux source -t $tmux_session ~/.config/tmux/theme.$color_scheme.tmux
end
